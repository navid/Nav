...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 639.0, 190.0, 63.0, 20.0 ],
					"text" : "s AccMag"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 639.0, 148.0, 179.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 674.0, 28.0, 83.0, 20.0 ],
					"text" : "r everythingO"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 639.0, 28.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 639.0, 57.0, 54.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
,
					"patching_rect" : [ 186.5, 145.0, 67.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.5, 30.0, 83.0, 20.0 ],
					"text" : "r everythingO"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 368.5, 30.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.5, 59.0, 54.0, 20.0 ],
					"text" : "gate 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "FullPacket" ],
					"patching_rect" : [ 639.0, 86.0, 169.0, 20.0 ],
...
,
					"patching_rect" : [ 368.5, 88.0, 69.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 186.5, 88.0, 161.0, 20.0 ],
					"text" : "o.xosc.seperator /shoe_10R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 9.5, 88.0, 159.0, 20.0 ],
					"text" : "o.xosc.seperator /shoe_10L"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.5, 173.0, 504.0, 275.0 ],
					"text" : "/shoe_10R/was/accelerometer/raw 0. 0. 0.\n/shoe_10R/was/time 2014-03-03T00:21:07.999402Z\n/shoe_10R/accelerometer/offset 0.0246582 0.0107422 0.0769043\n/shoe_10R/gyro/offset -5.08552 -1.02805 0.481402\n/shoe_10R/gyro/raw 0. 0. 0.\n/shoe_10R/accelerometer/raw 0. 0. 0.\n/shoe_10R/magnetometer/raw 0. 0. 0.\n/shoe_10R/temperature 0.\n/shoe_10R/time 2014-03-03T00:21:16.225352Z\n/shoe_10R/accelerometer/calibrated/ -0.0246582 -0.0107422 -0.0769043\n/shoe_10R/gyro/calibrated/value 5.08552 1.02805 -0.481402\n/shoe_10R/acceleration/magnitude -1.\n/shoe_10R/threshold 1\n/shoe_10R/maxima\n/shoe_10R/stasis_threshold 0\n/shoe_10R/pressure/front1 0.\n/shoe_10R/pressure/front2 0.\n/shoe_10R/pressure/front3 0.\n/shoe_10R/pressure/back 0.\n/shoe_10R/pressure/total 0.\n",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/NavNav/code/Nav/IO/XOSC",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
