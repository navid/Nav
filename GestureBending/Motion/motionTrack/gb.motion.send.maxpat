...
,
		"rect" : [ 244.0, 96.0, 188.0, 80.0 ],
		"bgcolor" : [ 0.145167, 0.0, 0.403745, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 45.0, 153.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 12.0, 157.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 53.0, 73.25, 157.0, 27.0 ],
					"text" : "GB.motionTrack%"
				}
