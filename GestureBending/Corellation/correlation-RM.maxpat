...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 622.0, 362.0, 82.0, 20.0 ],
					"text" : "zsa.centroid~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 521.0, 220.0, 50.0, 20.0 ],
					"presentation_rect" : [ 563.0, 248.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 497.5, 247.0, 42.5, 20.0 ],
					"presentation_rect" : [ 539.0, 275.0, 0.0, 0.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 662.0, 220.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 638.0, 247.0, 42.5, 20.0 ],
					"presentation_rect" : [ 655.0, 275.0, 0.0, 0.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 497.5, 275.0, 159.5, 20.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 357.0, 135.0, 300.0, 70.0 ],
