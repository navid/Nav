...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 668.0, 614.0, 167.0, 18.0 ],
					"text" : "to_texture tex_ctx_main_fluid"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 726.5, 582.5, 67.0, 20.0 ],
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 682.5, 648.0, 220.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 631.0, 706.5, 604.0, 33.0 ],
					"text" : "jit.gl.videoplane video @scale 1. 1. 1. @position 0. 0. 0. @blend_enable 0 @depth_enable 0 @transform_reset 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1266.0, 670.0, 49.0, 20.0 ],
					"text" : "r metro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1510.0, 706.5, 81.0, 18.0 ],
					"text" : "fullscreen $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1266.0, 706.5, 57.0, 20.0 ],
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 993.0, 870.5, 536.0, 33.0 ],
					"text" : "jit.gl.videoplane ctx_spl_fluid_2 @texture tex_ctx_main_fluid @transform_reset 2 @tex_scale_y 2. @tex_offset_y -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 993.0, 835.5, 500.0, 20.0 ],
					"text" : "jit.window ctx_spl_fluid_2 @shared 1 @size 320 240 @grow 0 @title \"fluid 2\" @pos 20 -700"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 993.0, 768.5, 337.0, 20.0 ],
					"text" : "jit.gl.render ctx_spl_fluid_2 @erase_color 0. 0. 0. 1. @ortho 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 993.0, 800.5, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1151.0, 800.5, 191.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1484.0, 870.5, 533.0, 20.0 ],
					"text" : "jit.gl.videoplane ctx_spl_fluid_1 @texture tex_ctx_main_fluid @transform_reset 2 @tex_scale_y 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1484.0, 835.5, 506.0, 20.0 ],
					"text" : "jit.window ctx_spl_fluid_1 @shared 1 @size 320 240 @grow 0 @title \"fluid 1\" @pos 20 -1400"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1484.0, 768.5, 337.0, 20.0 ],
					"text" : "jit.gl.render ctx_spl_fluid_1 @erase_color 0. 0. 0. 1. @ortho 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 997.0, 935.5, 308.0, 20.0 ],
					"text" : "jit.gl.texture video @adapt 1 @name tex_ctx_main_fluid"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1484.0, 800.5, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1642.0, 800.5, 191.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 1412.0, 706.5, 40.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 541.0, 935.5, 204.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 412.0, 968.0, 169.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 326.765228, 169.0, 21.0 ],
...
,
					"patching_rect" : [ 315.5, 846.0, 42.0, 21.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 351.5, 140.0, 150.0, 20.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 340.0, 104.0, 51.0, 20.0 ],
													"text" : "s metro"
												}
