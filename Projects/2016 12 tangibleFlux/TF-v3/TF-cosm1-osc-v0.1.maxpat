...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 79.760872, 230.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "loadmess 88"
				}
...
,
					"patching_rect" : [ 348.0, 463.0, 36.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 625.0, 120.0, 73.0, 20.0 ],
					"style" : "",
					"text" : "index depth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 581.0, 58.0, 137.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 182.0, 84.0, 22.0, 140.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 147.0, 84.0, 22.0, 140.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 241.5, 57.0, 22.0 ],
					"style" : "",
					"text" : "dac~ 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 581.0, 118.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 581.0, 84.5, 92.0, 22.0 ],
					"style" : "",
					"text" : "slide~ 5. 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.260872, 1.0, 150.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 502.0, 463.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "modfreq $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 502.0, 434.0, 125.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 502.0, 408.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "r val"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 581.0, 10.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "adc~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 417.0, 10.0, 150.0, 350.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 79.760872, 49.0, 168.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 230.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 259.0, 10.0, 150.0, 350.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 27.0, 23.0, 161.0, 22.0 ],
					"style" : "",
