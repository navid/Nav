...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 120.0, 435.0, 180.0, 22.0 ],
					"style" : "",
					"text" : "j.receive /oscil_base/osc3_base"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 315.0, 45.0, 123.0, 35.0 ],
									"style" : "",
									"text" : "j.receive /oscil_base/osc3_rvb"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "j.receive /oscil_base/osc3_dry"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 45.0, 330.0, 138.0, 22.0 ],
					"style" : "",
					"text" : "pvh.lpg~.model lpg3_ba"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 105.0, 379.0, 22.0 ],
									"style" : "",
									"text" : "j.parameter osc3_base @type decimal @range 0. 1. @clipmode both"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 76.0, 369.0, 22.0 ],
									"style" : "",
									"text" : "j.parameter osc3_rvb @type decimal @range 0. 1. @clipmode both"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 45.0, 369.0, 22.0 ],
									"style" : "",
									"text" : "j.parameter osc3_dry @type decimal @range 0. 1. @clipmode both"
								}
...
,
					"patching_rect" : [ 690.0, 270.0, 77.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 45.0, 135.0, 181.0, 22.0 ],
					"style" : "",
					"text" : "nav.cook~.module drive_base"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 45.0, 270.0, 188.0, 22.0 ],
					"style" : "",
					"text" : "pvh.complexosc~.model osc3_ba"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 54.5, 215.0, 110.833333, 215.0 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
