...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 837.0, 475.0, 32.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 798.0, 475.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 722.0, 428.0, 46.0, 20.0 ],
					"presentation_rect" : [ 724.0, 428.0, 0.0, 0.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 666.0, 428.0, 46.0, 20.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 849.0, 361.0, 99.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 847.0, 361.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 90.0, 79.0, 20.0 ],
					"text" : "loadmess 65"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 696.0, 90.0, 79.0, 20.0 ],
					"text" : "loadmess 90"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.5, 483.0, 74.0, 20.0 ],
					"text" : "s 2cueRogs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 666.0, 533.5, 74.0, 20.0 ],
					"text" : "s 2cueRogs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.5, 305.0, 72.0, 20.0 ],
					"text" : "r 2cueRogs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 754.0, 575.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 608.0, 575.0, 143.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 513.0, 63.0, 20.0 ],
					"text" : "pipe 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 330.0, 483.0, 34.0, 20.0 ],
					"text" : "t 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 330.0, 455.0, 69.0, 20.0 ],
					"text" : "delay 4000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 428.0, 174.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.5, 455.0, 119.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 802.0, 513.0, 29.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 666.0, 503.0, 55.0, 18.0 ],
					"text" : "/select 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 722.0, 503.0, 55.0, 18.0 ],
					"text" : "/select 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 666.0, 398.0, 111.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 232.5, 50.0, 31.0 ],
					"text" : "/audio/mute 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.5, 232.5, 63.0, 31.0 ],
					"text" : "/audio/mute 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 666.0, 361.0, 113.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 297.0, 113.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.5, 325.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 466.0, 247.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 915.0, 49.5, 47.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 278.0, 47.0, 20.0 ],
					"text" : "adc~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 784.0, 78.0, 150.0, 245.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 616.0, 2.0, 150.0, 245.0 ]
				}
...
,
					"patching_rect" : [ 696.0, 146.0, 67.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 389.0, 5.0, 300.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 309.0, 2.0, 300.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 696.0, 128.0, 67.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 309.0, 198.0, 300.0, 12.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.0, 213.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 309.0, 140.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 380.0, 546.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 231.0, 89.0, 20.0 ],
					"text" : "num speakers:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.5, 257.0, 81.0, 20.0 ],
					"text" : "r 2rogsRVRB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 473.0, 575.0, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.0, 546.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 108.0, 231.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 575.0, 143.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 605.0, 182.0, 19.0 ],
...
,
					"patching_rect" : [ 316.0, 146.0, 67.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 9.0, 5.0, 300.0, 140.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 362.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 158.0, 286.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 316.0, 128.0, 67.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 198.0, 300.0, 12.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 9.0, 283.5, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 158.0, 216.0, 300.0, 70.0 ],
					"varname" : "/reverb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 154.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 140.0, 300.0, 70.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-24::obj-108::obj-67" : [ "SelectAll[5]", "SelectAll", 0 ],
			"obj-4::obj-108::obj-67" : [ "SelectAll[4]", "SelectAll", 0 ],
			"obj-24::obj-74" : [ "note[2]", "Note", 0 ],
			"obj-4::obj-74" : [ "note[1]", "Note", 0 ],
			"obj-24::obj-43::obj-131::obj-54::obj-9::obj-61" : [ "TriggersMode[4]", "Mode", 0 ],
			"obj-24::obj-108::obj-87" : [ "Direction[2]", "Direction", 0 ],
			"obj-24::obj-108::obj-101" : [ "Scrub[2]", "Scrub", 0 ],
			"obj-24::obj-51" : [ "Soundfile[2]", "Soundfile", 0 ],
			"obj-4::obj-108::obj-32" : [ "live.text[7]", "live.text[3]", 0 ],
			"obj-4::obj-108::obj-103" : [ "Direction[9]", "Direction", 0 ],
			"obj-24::obj-108::obj-103" : [ "Direction[1]", "Direction", 0 ],
			"obj-24::obj-68" : [ "DropFile[2]", "DropFile", 0 ],
			"obj-4::obj-89" : [ "lock[1]", "Lock", 0 ],
			"obj-24::obj-69" : [ "SelectFile[2]", "SelectFile", 0 ],
			"obj-4::obj-69" : [ "SelectFile[1]", "SelectFile", 0 ],
			"obj-4::obj-68" : [ "DropFile[1]", "DropFile", 0 ],
			"obj-24::obj-108::obj-32" : [ "live.text[1]", "live.text[3]", 0 ],
			"obj-24::obj-89" : [ "lock[2]", "Lock", 0 ],
...
, 			{
				"name" : "jmod.sur.reverb~.maxpat",
				"bootpath" : "/Users/tangibleflux/code/SearchPath/JamomaUsers/ViMiC/spatialization/sur.reverb~",
...
, 			{
				...
				"bootpath" : "/Users/tangibleflux/code/SearchPath/JamomaUsers/GMEA/Projects/CP.interface/patchers",
...
, 			{
				"name" : "jmod.nav.rogs~.maxpat",
				"bootpath" : "/Users/tangibleflux/code/Nav/Jamoma/jmod.nav.rogs~",
...
, 			{
				...
				"bootpath" : "/Users/tangibleflux/code/Nav/Jamoma/jmod.nav.oscRoute",
...
, 			{
				"name" : "jmod.nav.env~.maxpat",
				"bootpath" : "/Users/tangibleflux/code/Nav/Jamoma/jmod.nav.env~",
