...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 480.0, 135.0, 91.0, 49.0 ],
									"style" : "",
									"text" : "j.message y @type decimal @range -1. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 375.0, 135.0, 91.0, 49.0 ],
									"style" : "",
									"text" : "j.message x @type decimal @range -1. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 255.0, 135.0, 105.0, 49.0 ],
									"style" : "",
									"text" : "j.message LED2 @type decimal @range 0. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 135.0, 135.0, 105.0, 49.0 ],
									"style" : "",
									"text" : "j.message LED1 @type decimal @range 0. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 135.0, 105.0, 49.0 ],
									"style" : "",
									"text" : "j.message speed @type decimal @range 0. 1."
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 238.9, 123.0, 264.5, 123.0 ],
									"source" : [ "obj-7", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 346.1, 123.0, 384.5, 123.0 ],
									"source" : [ "obj-7", 3 ]
								}
