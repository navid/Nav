...
,
		"openrect" : [ 300.0, 30.0, 300.0, 880.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 645.0, 300.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "j.model"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 75.0, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 195.0, 345.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 240.0, 345.0, 125.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 540.0, 168.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 120.0, 435.0, 166.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 495.0, 735.0, 105.0, 49.0 ],
					"style" : "",
					"text" : "j.remote /oscil_base/osc3_base"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 510.0, 705.0, 60.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 495.0, 705.0, 90.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 690.0, 16.0, 66.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 465.0, 16.0, 51.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 495.0, 510.0, 105.0, 49.0 ],
					"style" : "",
					"text" : "j.remote /oscil_base/osc3_rvb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 495.0, 615.0, 105.0, 49.0 ],
					"style" : "",
					"text" : "j.remote /oscil_base/osc3_dry"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 510.0, 585.0, 30.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 495.0, 585.0, 107.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 510.0, 480.0, 60.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 495.0, 480.0, 107.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 465.0, 150.0, 225.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 165.0, 15.0, 95.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 315.0, 120.0, 101.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 120.0, 103.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 315.0, 45.0, 128.0, 35.0 ],
									"style" : "",
									"text" : "j.receive mixer/osc3/reverb/wet"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 165.0, 44.999985, 135.0, 35.0 ],
									"style" : "",
									"text" : "j.receive mixer/osc3/reverb/dry"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 174.5, 84.499992, 174.5, 84.499992 ],
									"source" : [ "obj-26", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 324.5, 84.499992, 324.5, 84.499992 ],
									"source" : [ "obj-36", 0 ]
								}
...
,
					"patching_rect" : [ 360.0, 300.0, 90.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 299.0, 103.0, 22.0 ],
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 180.0, 130.0, 110.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 360.0, 150.0, 105.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 105.0, 395.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 76.0, 405.0, 22.0 ],
									"style" : "",
									"text" : "j.parameter osc3/reverb/wet @type decimal @range 0. 1. @clipmode both"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 45.0, 403.0, 22.0 ],
									"style" : "",
									"text" : "j.parameter osc3/reverb/dry @type decimal @range 0. 1. @clipmode both"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 240.0, 161.0, 22.0 ],
									"style" : "",
									"text" : "j.send cues_osc_base/recall"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 15.0, 180.0, 199.0, 22.0 ],
									"style" : "",
									"text" : "j.receive cues_osc_base/read/done"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 150.0, 175.0, 22.0 ],
									"style" : "",
									"text" : "j.send cues_osc_base/file/path"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "j.initialized cues_osc_base 400"
								}
...
,
					"patching_rect" : [ 645.0, 270.0, 36.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 45.0, 135.0, 147.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.0, 75.0, 300.0, 175.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 45.0, 105.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "adc~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 15.0, 150.0, 350.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 690.0, 150.0, 105.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 54.5, 215.0, 104.166667, 215.0 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 504.5, 674.0, 480.0, 674.0, 480.0, 579.0, 504.5, 579.0 ],
					"source" : [ "obj-128", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 504.5, 561.0, 480.0, 561.0, 480.0, 474.0, 504.5, 474.0 ],
					"source" : [ "obj-131", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 504.5, 786.0, 480.0, 786.0, 480.0, 699.0, 504.5, 699.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 167.5, 421.5, 99.5, 421.5 ],
					"source" : [ "obj-40", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"midpoints" : [ 249.5, 377.5, 54.5, 377.5 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 129.5, 482.0, 110.0, 482.0 ],
					"order" : 0,
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 129.5, 482.0, 65.0, 482.0 ],
					"order" : 1,
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 99.5, 528.0, 203.5, 528.0 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 369.5, 333.0, 249.5, 333.0 ],
					"source" : [ "obj-7", 0 ]
				}
