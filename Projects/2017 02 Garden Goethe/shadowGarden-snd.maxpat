...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"color" : [ 0.06873, 0.153274, 0.833078, 1.0 ],
					"fontface" : 1,
					"fontname" : "Arial",
					"fontsize" : 14.0,
					"id" : "obj-4",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 374.0, 179.0, 109.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 84.0, 72.0, 109.0, 22.0 ],
					"text" : "WATER-goethe"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 414.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.839216, 0.306872, 0.293844, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-15",
					"maxclass" : "newobj",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 78.5, 9.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 113.0, 102.26001, 153.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 78.5, 53.0, 37.0, 19.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 264.0, 3.0, 40.0, 19.0 ],
									"text" : "read"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 361.0, 186.0, 165.0, 21.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 376.5, 252.0, 134.0, 36.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 349.5, 35.0, 118.0, 31.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 24.0, 3.0, 145.0, 18.0 ],
									"text" : "read shadowGarden.mov"
								}
...
,
					"patching_rect" : [ 384.310028, 292.0, 83.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 17.643372, 184.0, 83.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 595.0, 497.0, 57.0, 20.0 ],
					"text" : "pipe 400"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 582.0, 444.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.643372, 213.0, 300.0, 105.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.643372, 99.0, 300.0, 105.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 478.0, 624.0, 160.0, 20.0 ],
					"text" : "jit.window oij @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 384.310059, 609.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 478.0, 557.880005, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 478.0, 529.880005, 43.0, 20.0 ],
					"text" : "sel 27"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 478.0, 494.880005, 59.5, 20.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 478.0, 584.402222, 81.0, 18.0 ],
					"text" : "fullscreen $1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 219.0, 132.5, 60.0, 20.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 111.0, 163.0, 99.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 219.0, 163.0, 93.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 256.0, 67.5, 69.0, 20.0 ],
									"text" : "delay 5000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 300.0, 96.5, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 2.0, 182.5, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 2.0, 96.5, 81.0, 17.0 ],
									"text" : "/camera/open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 2.0, 67.5, 69.0, 20.0 ],
									"text" : "delay 3000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.0, 96.5, 52.0, 18.0 ],
									"text" : "select 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 90.0, 67.5, 69.0, 20.0 ],
									"text" : "delay 1000"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 2.0, 36.0, 259.0, 20.0 ],
									"text" : "t b b b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 162.0, 96.5, 122.0, 18.0 ],
									"text" : "load gardencues2.txt"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 2.0, 5.0, 179.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 90.0, 127.5, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 147.310059, 19.029541, 115.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 189.310059, 454.765228, 36.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.643372, 129.419983, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.643372, 2.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 103.310036, 324.880005, 300.0, 245.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 207.265228, 300.0, 245.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 455.0, 344.419983, 43.0, 43.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 455.0, 395.419983, 43.0, 20.0 ],
					"text" : "s start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.310059, 49.390015, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 454.765228, 300.0, 70.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-1::obj-34::obj-69" : [ "live.tab[1]", "live.tab", 0 ],
			"obj-4::obj-27::obj-44" : [ "live.menu[3]", "live.menu", 0 ],
			"obj-4::obj-1::obj-48::obj-69" : [ "live.tab[13]", "live.tab", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "jmod.cueManager.maxpat",
...
, 			{
				"name" : "jmod.o4.fluids%.maxpat",
				"bootpath" : "/Users/NavNav/code/Git/TML-depo/TML-code/VIDEO/legacy/Dependencies/jmod.o4.fluids%",
				"patcherrelativepath" : "../../code/Git/TML-depo/TML-code/VIDEO/legacy/Dependencies/jmod.o4.fluids%",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "WATER-goethe.maxpat",
				"bootpath" : "/Users/NavNav/Desktop/WATER",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
