...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 41.0, 303.0, 100.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 153.0, 290.0, 531.0, 19.0 ],
									"text" : "jcom.parameter schmitt/on @type boolean @range/clipmode none @description \"Turn tigger detection on.\"",
									"varname" : "clip[3]"
								}
