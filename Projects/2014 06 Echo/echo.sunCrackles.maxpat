...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.0, 1026.0, 148.0, 18.0 ],
					"text" : "load sunCracklecuelist.txt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.0, 999.0, 161.0, 20.0 ],
					"text" : "jcom.initialized /crackleCues"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 362.0, 802.0, 134.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 154.0, 576.0, 147.0, 16.0 ],
					"text" : "/file/open Electricity-tool-EQ.aif"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 362.0, 782.0, 147.0, 20.0 ],
					"text" : "jcom.initialized /crackle3~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 450.0, 164.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 132.0, 287.0, 161.0, 18.0 ],
					"text" : "/file/open fireMidHigh-EQ.aif"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 424.0, 147.0, 20.0 ],
					"text" : "jcom.initialized /crackle2~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 362.0, 89.0, 173.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 128.0, 0.0, 169.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 362.0, 57.0, 147.0, 20.0 ],
					"text" : "jcom.initialized /crackle1~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 1068.5, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 864.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 22.0, 821.0, 300.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 646.0, 300.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 22.0, 476.0, 300.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 357.0, 300.0, 140.0 ]
				}
...
,
					"patching_rect" : [ 329.0, 967.0, 67.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 329.0, 949.0, 67.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 844.0, 300.0, 12.0 ]
				}
...
,
					"patching_rect" : [ 22.0, 793.0, 49.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 717.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 576.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 974.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 786.0, 300.0, 70.0 ]
				}
...
,
					"patching_rect" : [ 329.0, 622.0, 67.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 329.0, 604.0, 67.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 555.0, 300.0, 12.0 ]
				}
...
,
					"patching_rect" : [ 22.0, 450.0, 49.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 374.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 631.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 497.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 22.0, 133.0, 300.0, 140.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 329.0, 279.0, 67.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 329.0, 261.0, 67.0, 12.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 22.0, 113.0, 49.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 31.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 287.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-22::obj-108::obj-67" : [ "SelectAll[1]", "SelectAll", 0 ],
			"obj-21::obj-89" : [ "lock[3]", "Lock", 0 ],
			"obj-22::obj-69" : [ "SelectFile[1]", "SelectFile", 0 ],
			...
			"obj-22::obj-108::obj-32" : [ "live.text[1]", "live.text[3]", 0 ],
			...
			"obj-21::obj-43::obj-131::obj-54::obj-9::obj-61" : [ "TriggersMode[5]", "Mode", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "jmod.sur.output~.maxpat",
