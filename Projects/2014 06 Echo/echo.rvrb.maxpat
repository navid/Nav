...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 381.0, 39.5, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 163.0, 2.0, 89.0, 20.0 ],
					"text" : "num speakers:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.5, 7.0, 81.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.5, 2.0, 81.0, 20.0 ],
					"text" : "r 2rogsRVRB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 474.0, 68.5, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 331.0, 39.5, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 252.0, 2.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 68.5, 143.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 98.5, 182.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 112.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 92.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.0, 33.5, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 22.0, 300.0, 70.0 ],
					"varname" : "/reverb"
				}
