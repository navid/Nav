...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 3.0, 119.0, 20.0 ],
					"text" : "r command2surVerb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.5, 3.0, 81.0, 20.0 ],
					"text" : "r 2rogsRVRB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 111.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 71.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 29.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jmod.sur.reverb~.maxpat",
				"bootpath" : "/Users/Cooking/Code/SearchPath/JamomaUsers/ViMiC/spatialization/sur.reverb~",
...
, 			{
				...
				"bootpath" : "/Users/Cooking/Code/SearchPath/JamomaUsers/GMEA/Projects/CP.interface/patchers",
