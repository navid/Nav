...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 706.090881, 143.0, 67.0, 19.0 ],
					"text" : "loadmess 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.090881, 277.227295, 300.0, 70.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 100.0, 588.0, 206.0 ],
									"text" : "aperture 53.3, aperturecolor 1. 1. 1. 0.619608, areasmonitoring 0, automaticspeakerstimealignment 0, autozoom 0, axis 0. -30. 0. 0. 20. 5657., backgroundimage none, backgroundimageangle 0., backgroundimageopacity 1., backgroundimagequality medium, backgroundimagescale 1., backgroundimagexoffset 0., backgroundimageyoffset 0., bril 29., bypass 0, circularconstraint 0, cluster_distr 0.5, cluster_end 105.64, cluster_start 42.47, defer 1, delays 0. 0. 0. 0. 0. 0. 0. 0., display 1, doppler 1, drop 6.2, dropmode log2, early_distr 0.5, early_end 39.71, early_shape 0.5, early_start 22.22, early_width 30., env 24., format aed, globalproportion 0.1, gridlines 3, gridmode circular, gridspacing 1., heaviness 25., height 400, infinite 0, listenereditable 0, listenerpitch 0., listenerposition 0. 0. 0., listenerproportion 0.15, listenerroll 0., listeneryaw 0., liveness 35., modaldensity 0., multipleoutlets 0, mute 0, name \"1\", numanchors 0, numangulardivisions 8, numareas 0, numcascades 1, numinternals 8, numreverbs 1, numsources 1, numspeakers 8, omni 3.15 -30. 0. -3.8 20. 5657., orientationmode yawconstraint, outputfiltersQ 1. 1. 1. 1. 1. 1. 1. 1., outputfiltersfreq 1000. 1000. 1000. 1000. 1000. 1000. 1000. 1000., outputfiltersgain 0. 0. 0. 0. 0. 0. 0. 0., outputfilterstype Null Null Null Null Null Null Null Null, pan_rev 0., pitch 0., prer 48., pres 85.017899, radius 0.6, radiusconstraint 0, reverb_start 95.37, reverberance 65., reverbfreqhigh 8000., reverbfreqlow 250., reverbid 1, revp 34., rightclicklock 0, roomactive 1, roomairabsorption 1, roomairrolloff 10000., shoeboxcorners 0. 0. 0. 1. -1. 0., showanchors 0, showanchorslabel 0, showangulardivisions 1, showaperture 1, showareas 0, showbackgroundimage 1, showcriteria 0, showfps 0, showheadphones 0, showlegend 1, showlistener 1, showpresence 1, showradius 1, showshoebox 0, showsources 1, showsourceslabel 1, showspeakers 1, showspeakershull 0, showspeakerslabel 1, showspeakersprojection 0, showspeakersradius 0, showspeakerstriangulation 0, showviewer 1, sourceairabsorption 1, sourcecolor 0.490196 1. 0. 1., sourcemute 0, sourceproportion 0.07, sourceseditable 1, sourcesolo 0, sourcespositions 0.010828 1.033943 0., speakerseditable 0, speakerseq 0, speakerspositions -0.446927 0.899441 0. 0.441341 0.893855 0. 0.932961 0.402235 0. 0.893855 -0.385475 0. 0.441341 -0.877095 0. -0.441341 -0.882682 0. -0.888268 -0.385475 0. -0.916201 0.413408 0., speakersproportion 0.1, speakerstimealignment 0, useopengl 0, vieweronly 0, viewpoint top, warmth 30., width 400, windowmoveable 1, windowtitle Oper, windowtopleft 50. 800., xoffset 0., yaw 0., yoffset 0., zoffset 0., zoom 1., zoomlock 0,"
								}
...
,
					"patching_rect" : [ 205.090897, 67.318176, 40.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 205.090897, 36.31818, 29.0, 29.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 37.909119, 104.727234, 108.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 37.909119, 73.727234, 45.0, 19.0 ],
									"text" : "route 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 10.909119, 8.0, 37.0, 18.0 ],
									"text" : "midiin"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 10.909119, 37.0, 100.0, 18.0 ],
									"text" : "midiparse"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 37.909119, 135.999939, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 245.090897, 6.81818, 59.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.090912, 236.227295, 286.0, 97.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 52.590897, 340.227295, 253.500015, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 53.465912, 193.227295, 286.0, 38.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.090881, 187.727295, 73.0, 19.0 ],
					"text" : "speedlim 10."
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.839216, 0.319147, 0.336967, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 13.0,
					"id" : "obj-39",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.465912, 33.818176, 76.0, 21.0 ],
					"text" : "r na-spat-ui"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.090881, 6.81818, 58.0, 19.0 ],
					"text" : "r 2ambiM"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 160.0, 393.0, 33.0, 20.0 ],
									"text" : "* -1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 314.0, 393.0, 33.0, 20.0 ],
									"text" : "* -1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 131.5, 122.0, 75.0, 20.0 ],
									"text" : "speedlim 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 285.5, 122.0, 75.0, 20.0 ],
									"text" : "speedlim 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 411.0, 116.0, 75.0, 20.0 ],
									"text" : "speedlim 20"
								}
...
,
									"patching_rect" : [ 324.5, 8.0, 59.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 336.0, 146.0, 150.0, 245.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 183.0, 146.0, 150.0, 245.0 ],
									"presentation_rect" : [ 0.0, 0.0, 150.0, 245.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 29.0, 146.0, 150.0, 245.0 ],
									"presentation_rect" : [ 0.0, 0.0, 150.0, 245.0 ]
								}
...
,
									"patching_rect" : [ 160.0, 417.0, 326.0, 19.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Verdana",
										"default_fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 7,
									"outlettype" : [ "", "", "", "", "", "", "" ],
									"patching_rect" : [ 4.0, 95.0, 271.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 4.0, 74.0, 97.0, 19.0 ],
...
,
					"patching_rect" : [ 368.090881, 236.227295, 89.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 706.090881, 187.727295, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 555.090881, 30.22728, 150.0, 150.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.090881, 212.227295, 170.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 245.090897, 30.22728, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 155.090897, 33.818176, 35.0, 17.0 ],
					"text" : "reset"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.590912, 191.318146, 62.965912, 191.318146 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 535.590881, 182.818146, 62.965912, 182.818146 ],
					"source" : [ "obj-6", 2 ]
				}
