...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 142.0, 555.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 95.0, 241.0, 150.0, 20.0 ],
					"text" : "start audio"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.0, 521.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 95.0, 217.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 58.0, 520.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 46.0, 215.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 58.0, 607.0, 127.0, 22.0 ],
					"text" : "transport"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 555.0, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 241.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.0, 37.0, 44.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 225.0, 10.0, 150.0, 20.0 ],
					"text" : "value"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 152.0, 45.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 248.0, 158.0, 150.0, 20.0 ],
					"text" : "range"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 177.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 430.0, 33.0, 20.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 256.0, 29.0, 20.0, 129.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 344.0, 374.0, 63.0, 22.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.0, 399.0, 236.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 467.0, 226.0, 149.0, 142.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 328.0, 29.0, 150.0, 129.0 ],
					"setminmax" : [ 0.0, 127.0 ],
					"setstyle" : 5,
					"settype" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 344.0, 33.0, 20.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 232.0, 29.0, 20.0, 129.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 229.0, 74.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 367.0, 258.0, 41.0, 114.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 283.0, 29.0, 41.0, 129.0 ]
				}
...
,
					"patching_rect" : [ 344.0, 201.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 62.0, 391.0, 76.0, 22.0 ],
					"text" : "slide~ 20. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 183.0, 147.0, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 182.0, 193.0, 41.0, 22.0 ],
					"text" : "t 0. 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 184.0, 170.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 214.0, 376.0, 76.0, 22.0 ],
					"text" : "snapshot~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 111.0, 185.0, 38.0, 22.0 ],
					"text" : "rate~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 129.0, 130.0, 49.33984375, 19.171875 ],
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 29.0, 49.33984375, 19.171875 ],
					"rounded" : 8.0,
					"text" : "normal",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 135.0, 309.0, 32.5, 22.0 ],
					"text" : "+ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 98.0, 288.0, 32.5, 22.0 ],
					"text" : "+ 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 98.0, 267.0, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 140.0, 40.0, 20.0 ],
					"prototypename" : "Live",
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 135.0, 288.0, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 78.0, 40.0, 20.0 ],
					"prototypename" : "Live",
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 417.0, 112.0, 80.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 61.0, 243.0, 93.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 106.0, 108.0, 56.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 51.0, 56.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 60.0, 60.0, 129.0, 22.0 ],
...
,
					"patching_rect" : [ 61.0, 157.0, 87.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 84.0, 87.0, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 51.0, 40.0, 20.0 ],
					"prototypename" : "Live",
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 41.0, 29.0, 56.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 29.0, 56.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 212.0, 250.0, 20.0, 80.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 70.5, 212.0, 70.5, 212.0 ],
					"source" : [ "obj-111", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 224.0, 346.0, 197.5, 346.0, 197.5, 226.0, 144.5, 226.0 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 1 ],
					"midpoints" : [ 220.0, 338.0, 206.5, 338.0, 206.5, 219.0, 107.5, 219.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 70.5, 359.0, 223.5, 359.0 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 107.5, 344.0, 189.5, 344.0, 189.5, 240.0, 220.0, 240.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 223.5, 428.0, 457.0, 428.0, 457.0, 216.0, 476.5, 216.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 1 ],
					"midpoints" : [ 144.5, 333.0, 181.5, 333.0, 181.5, 233.0, 224.0, 233.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 67.5, 547.0, 102.5, 547.0 ],
					"order" : 0,
					"source" : [ "obj-7", 0 ]
				}
