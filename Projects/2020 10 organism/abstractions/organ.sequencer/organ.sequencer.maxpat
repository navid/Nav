...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 584.0, 456.0, 53.0, 22.0 ],
					"text" : "route 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 655.0, 569.0, 50.0, 35.0 ],
					"text" : "/turn 40 65"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dec" ],
					"patching_rect" : [ 526.0, 507.0, 35.0, 22.0 ],
					"text" : "t dec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 389.0, 494.0, 63.0, 22.0 ],
					"text" : "select 127"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 483.0, 478.0, 73.0, 22.0 ],
					"text" : "select 65 63"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "inc" ],
					"patching_rect" : [ 483.0, 507.0, 31.0, 22.0 ],
					"text" : "t inc"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 483.0, 538.0, 20.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 408.0, 448.0, 69.0, 22.0 ],
					"text" : "route 40 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 408.0, 418.0, 372.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 408.0, 373.0, 104.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 104.0, 141.0, 22.0 ],
					"text" : "r seq-preset-transport-on"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 234.0, 83.0, 22.0 ],
					"text" : "prepend reset"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.372549019607843, 0.454901960784314, 0.572549019607843, 1.0 ],
					"id" : "obj-44",
					"maxclass" : "button",
					"numinlets" : 1,
					"numoutlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 166.0, 10.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 600.0, 287.0, 79.0, 22.0 ],
					"text" : "s midi2SEQ2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 478.0, 285.0, 79.0, 22.0 ],
					"text" : "s midi2SEQ1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 824.0, 3.0, 179.0, 20.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 849.0, 41.0, 62.0, 33.0 ],
					"text" : "Add one more!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 919.0, 36.0, 90.0, 22.0 ],
					"text" : "r seq-preset-no"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 264.0, 138.0, 77.0, 22.0 ],
					"text" : "r midi2SEQ2"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 272.0, 79.0, 22.0 ],
									"text" : "s midi2SEQ1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 156.0, 272.0, 79.0, 22.0 ],
									"text" : "s midi2SEQ2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 227.0, 234.0, 65.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 156.0, 234.0, 69.0, 21.0 ],
									"text" : "wrapFold $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 13.0, 207.0, 298.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 83.0, 234.0, 66.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 234.0, 69.0, 21.0 ],
									"text" : "wrapFold $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 407.0, 272.0, 79.0, 22.0 ],
									"text" : "s midi2SEQ1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 552.0, 272.0, 79.0, 22.0 ],
									"text" : "s midi2SEQ2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 618.0, 234.0, 64.0, 21.0 ],
									"text" : "duration $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 552.0, 234.0, 60.0, 21.0 ],
									"text" : "jumpBy $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 409.0, 207.0, 298.0, 22.0 ],
									"text" : "route 36 37 38 39"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 479.0, 234.0, 64.0, 21.0 ],
									"text" : "duration $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 407.0, 234.0, 60.0, 21.0 ],
									"text" : "jumpBy $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 407.0, 162.0, 79.0, 22.0 ],
									"text" : "s midi2SEQ1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 552.0, 162.0, 79.0, 22.0 ],
									"text" : "s midi2SEQ2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 618.0, 129.0, 65.0, 21.0 ],
									"text" : "loopMax $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 552.0, 129.0, 62.0, 21.0 ],
									"text" : "loopMin $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 125.0, 162.0, 79.0, 22.0 ],
									"text" : "s midi2SEQ2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 181.0, 130.0, 51.0, 21.0 ],
									"text" : "gate2 $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 125.0, 130.0, 51.0, 21.0 ],
									"text" : "gate1 $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 409.0, 102.0, 298.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 473.0, 129.0, 65.0, 21.0 ],
									"text" : "loopMax $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 407.0, 129.0, 62.0, 21.0 ],
									"text" : "loopMin $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 162.0, 79.0, 22.0 ],
									"text" : "s midi2SEQ1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 69.0, 130.0, 51.0, 21.0 ],
									"text" : "gate2 $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 130.0, 51.0, 21.0 ],
									"text" : "gate1 $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 13.0, 102.0, 243.0, 22.0 ],
									"text" : "route 32 33 34 35"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 13.0, 72.0, 811.0, 22.0 ],
									"text" : "ossia.router /push /turn"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 627.5, 263.0, 561.5, 263.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 488.5, 263.0, 416.5, 263.0 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 236.5, 263.0, 165.5, 263.0 ],
									"source" : [ "obj-18", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 92.5, 263.0, 22.5, 263.0 ],
									"source" : [ "obj-21", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 246.5, 191.5, 22.5, 191.5 ],
									"source" : [ "obj-27", 4 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 22.5, 160.000004410743713, 22.5, 160.000004410743713 ],
									"source" : [ "obj-62", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 697.5, 189.5, 418.5, 189.5 ],
									"source" : [ "obj-77", 4 ]
								}
...
,
					"patching_rect" : [ 670.000019967556, 236.000007033348083, 138.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.400002121925354, 136.000002026557922, 77.0, 22.0 ],
					"text" : "r midi2SEQ1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.00000524520874, 143.200002133846283, 179.0, 47.0 ],
					"presentation" : 1,
					"presentation_linecount" : 7,
					"presentation_rect" : [ 854.0, 197.0, 62.0, 100.0 ],
					"text" : "? / %sswing / psuh for signature\nbass offset\nvelocity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dec" ],
					"patching_rect" : [ 848.0, 125.0, 35.0, 22.0 ],
					"text" : "t dec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "inc" ],
					"patching_rect" : [ 815.0, 124.0, 31.0, 22.0 ],
					"text" : "t inc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 815.0, 100.0, 81.0, 22.0 ],
					"text" : "select inc dec"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 815.0, 190.0, 20.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 672.0, 73.0, 233.0, 22.0 ],
					"text" : "ossia.router /ON /preset-no /preset-incdec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 672.0, 40.0, 126.0, 22.0 ],
					"text" : "ossia.router /midi2seq"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 671.0, 8.0, 104.0, 22.0 ],
					"text" : "udpreceive 12321"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 583.0, 73.0, 39.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 122.0, 22.0, 67.0, 20.0 ],
					"text" : "80-86"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 553.0, 52.0, 67.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 50.0, 23.0, 67.0, 20.0 ],
					"text" : "cuzaz = 96"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 24.0, 52.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 47.0, 4.0, 52.0, 20.0 ],
					"text" : "nef = 90"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 88.0, 66.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 112.0, 348.0, 65.0, 22.0 ],
					"restore" : [ 99 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 180.0, 378.0, 50.0, 22.0 ],
					"text" : "select 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 948.0, 143.0, 50.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 908.0, 116.0, 27.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 948.0, 116.0, 49.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 908.0, 143.0, 28.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 557.0, 2.0, 37.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 997.0, 166.0, 35.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 950.0, 164.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 950.0, 192.0, 52.0, 22.0 ],
					"text" : "store $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 865.0, 189.0, 54.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 20.0, 40.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 865.0, 219.0, 158.0, 16.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 401.0, 12.0, 73.0, 22.0 ],
					"restore" : [ 0.000866141732284 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 324.0, 12.0, 73.0, 22.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 228.0, 12.0, 87.0, 22.0 ],
					"restore" : [ 7.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 132.0, 11.0, 87.0, 22.0 ],
					"restore" : [ 7.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 87.0, 34.0, 19.0 ],
					"text" : "mute~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 32.0, 65.0, 25.0, 19.0 ],
					"text" : "!= 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 309.0, 35.0, 19.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 389.0, 44.0, 19.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 33.0, 47.0, 20.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 32.0, 107.0, 354.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 196.0, 324.0, 23.0, 17.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 195.0, 310.0, 36.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 195.0, 342.0, 53.0, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 327.0, 338.0, 37.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 280.0, 338.0, 37.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 232.0, 366.0, 114.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 752.833333333333371, 178.5, 874.5, 178.5 ],
					"source" : [ "obj-29", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 220.5, 433.5, 184.5, 433.5 ],
					"source" : [ "obj-42", 1 ]
				}
