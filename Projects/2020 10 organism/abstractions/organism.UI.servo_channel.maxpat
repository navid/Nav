...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1533.0, 337.0, 95.0, 22.0 ],
					"text" : "r slider.speedlim"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1036.0, 26.0, 150.0, 20.0 ],
					"text" : "if lfo or fader"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 976.0, 25.0, 50.0, 22.0 ],
					"text" : "split 1 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 977.0, 53.0, 82.0, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1114.0, 199.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1305.0, 196.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1040.0, 223.0, 167.0, 22.0 ],
					"text" : "switch 2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1305.0, 173.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1114.0, 173.0, 107.0, 22.0 ],
					"text" : "join 2 @triggers -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1294.0, 136.0, 217.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1220.0, 103.0, 214.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1067.0, 136.0, 216.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 974.0, 103.0, 212.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 862.0, 767.0, 177.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 886.0, 635.0, 120.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 433.0, 698.0, 256.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 456.0, 579.0, 256.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1527.0, 8.0, 80.0, 24.0 ],
					"text" : "Meters"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1440.0, 285.0, 106.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1440.0, 330.0, 73.0, 22.0 ],
					"text" : "speedlim 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1527.0, 68.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1527.0, 38.0, 29.5, 22.0 ],
					"text" : "- 1"
				}
...
,
					"patching_rect" : [ 862.0, 599.0, 71.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 862.0, 644.0, 24.0, 111.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1527.0, 167.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1527.0, 99.0, 45.0, 60.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 318.0, 60.0, 51.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1527.0, 197.0, 146.0, 35.0 ],
					"text" : "ossia.remote #1/mixer/source"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1440.0, 360.0, 15.0, 135.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1449.5, 355.5, 1449.0, 355.5 ],
					"source" : [ "obj-1258", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1536.5, 162.0, 1536.5, 162.0 ],
					"source" : [ "obj-668", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1536.5, 191.0, 1536.5, 191.0 ],
					"source" : [ "obj-719", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1600.0, 263.0, 1512.0, 263.0, 1512.0, 32.0, 1536.5, 32.0 ],
					"source" : [ "obj-78", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 871.5, 794.0, 847.0, 794.0, 847.0, 631.0, 871.5, 631.0 ],
					"source" : [ "obj-936", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1025" : [ "RTmin[303]", "RTmin[10]", 0 ],
			"obj-1042" : [ "RTmin[299]", "RTmin[2]", 0 ],
			"obj-1135" : [ "number[263]", "number[96]", 0 ],
			"obj-1151" : [ "number[262]", "number[96]", 0 ],
			"obj-1257" : [ "multislider[107]", "multislider", 0 ],
			"obj-1345" : [ "RTmin[301]", "RTmin[10]", 0 ],
			"obj-1363" : [ "RTmin[300]", "RTmin[10]", 0 ],
			"obj-150" : [ "rslider[101]", "rslider[1]", 0 ],
			"obj-151" : [ "number[264]", "number[96]", 0 ],
			"obj-157" : [ "dial[96]", "dial", 0 ],
			"obj-20" : [ "live.text[234]", "live.text", 0 ],
			"obj-668" : [ "live.tab[157]", "live.tab", 0 ],
			"obj-68" : [ "live.text[184]", "live.text", 0 ],
			"obj-76" : [ "live.tab[158]", "live.tab[2]", 0 ],
			"obj-848" : [ "rslider[93]", "rslider[1]", 0 ],
			"obj-898" : [ "umenu[52]", "umenu", 0 ],
			"obj-922" : [ "multislider[108]", "multislider", 0 ],
			"obj-951" : [ "RTmin[304]", "RTmin[2]", 0 ],
			"obj-967" : [ "RTmin[302]", "RTmin[10]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
