...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 1064.0, 406.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 783.0, 414.0, 80.0, 20.0 ],
					"text" : "send~ sound"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 799.111145, 190.5, 53.0, 17.0 ],
					"text" : "s resonato"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 65.5, 160.0, 20.0 ],
					"text" : "Gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 97.5, 160.0, 20.0 ],
					"range" : [ 0.0, 2.0 ],
					"text" : "Transpose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 36.5, 160.0, 20.0 ],
					"range" : [ 0.0, 102.0 ],
					"text" : "Attenuation"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1077.0, 5.5, 160.0, 20.0 ],
					"range" : [ 0.0, 4.0 ],
					"text" : "Damping"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.000031, 100.0, 82.0, 18.0 ],
									"text" : "gain-scale $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 309.000061, 100.0, 112.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 223.0, 100.0, 77.0, 18.0 ],
									"text" : "attenuate $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.000031, 40.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 309.000061, 40.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 171.500031, 178.0, 25.0, 25.0 ]
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 145.500031, 147.5, 181.000031, 147.5 ],
									"source" : [ "obj-1", 0 ]
								}
...
,
					"patching_rect" : [ 924.0, 126.5, 135.444443, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 183.0, 120.0, 571.0, 165.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 183.0, 90.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 38.0, 68.0, 16.0, 16.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 19.0, 90.0, 65.0, 17.0 ],
									"text" : "mxj list.Reg"
								}
...
,
					"patching_rect" : [ 799.111145, 162.5, 143.888855, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 777.0, 458.5, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 777.0, 225.5, 300.0, 140.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 1209.0, 336.5, 40.0, 17.0 ],
					"text" : "t 0.5 s"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1119.0, 308.5, 100.0, 17.0 ]
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1239.0, 363.5, 68.0, 17.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1209.0, 390.5, 53.0, 17.0 ],
					"text" : "s resonato"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 917.5, 390.5, 45.0, 17.0 ],
					"text" : "*~ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 981.5, 390.5, 51.0, 17.0 ],
					"text" : "r resonato"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 917.5, 424.5, 135.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 387.0, 272.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 991.0, 415.5, 927.0, 415.5 ],
					"source" : [ "obj-14", 0 ]
				}
