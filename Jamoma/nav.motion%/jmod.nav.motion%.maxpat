...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "open" ],
					"patching_rect" : [ 563.0, 366.0, 43.0, 19.0 ],
					"text" : "t open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 563.0, 389.0, 51.0, 19.0 ],
					"text" : "pcontrol"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 109.0, 55.5, 496.0, 19.0 ],
									"text" : "jcom.parameter noise/ripple @type decimal @range/bounds 0. 1. @description \"center in jit.fasblur\"",
									"varname" : "scale/input/max[3]"
								}

							}
, 							{
								"box" : 								{
									"annotation" : "center in jit.fasblur",
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 102.0, 36.5, 36.0, 19.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 119.0, 30.0, 34.0, 19.0 ],
									"triangle" : 0,
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 109.0, 120.5, 487.0, 19.0 ],
									"text" : "jcom.parameter noise/ring @type decimal @range/bounds 0. 1. @description \"center in jit.fasblur\"",
									"varname" : "scale/input/max[2]"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 102.0, 101.5, 36.0, 19.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 79.0, 30.0, 34.0, 19.0 ],
									"triangle" : 0,
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 57.0, 0.0, 56.0, 18.0 ],
									"text" : "jit.fasblur"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 101.5, 54.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 76.0, 15.0, 27.0, 18.0 ],
									"text" : "ring"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 40.0, 168.5, 54.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 35.0, 15.0, 38.0, 18.0 ],
									"text" : "center"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 36.5, 54.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 116.0, 15.0, 34.0, 18.0 ],
									"text" : "ripple"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 140.0, 230.5, 597.0, 19.0 ],
									"text" : "jcom.parameter noise/range @type integer @range/bounds 0. 3. @range/clipmode both @description \"range for fasblur\"",
									"varname" : "slide/up[7]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 244.5, 54.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 1.0, 15.0, 36.0, 18.0 ],
									"text" : "range"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 83.0, 244.5, 44.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 4.0, 30.0, 17.0, 18.0 ],
									"triangle" : 0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 109.0, 188.5, 499.0, 19.0 ],
									"text" : "jcom.parameter noise/center @type decimal @range/bounds 0. 1. @description \"center in jit.fasblur\"",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 102.0, 169.5, 36.0, 19.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 38.0, 30.0, 34.0, 19.0 ],
									"triangle" : 0,
									"triscale" : 0.9
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 118.5, 152.5, 87.0, 152.5, 87.0, 98.5, 111.5, 98.5 ],
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 118.5, 220.5, 87.0, 220.5, 87.0, 166.5, 111.5, 166.5 ],
									"source" : [ "obj-24", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 118.5, 87.5, 87.0, 87.5, 87.0, 33.5, 111.5, 33.5 ],
									"source" : [ "obj-4", 0 ]
								}
...
,
					"patching_rect" : [ 563.0, 414.0, 47.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 554.0, 341.0, 37.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 102.545471, 22.545475, 32.545471, 18.0 ],
					"rounded" : 6.08,
					"text" : "noise"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 262.0, 903.0, 46.0, 19.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.0, 982.0, 108.0, 17.0 ],
					"text" : "script hide rad-com"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.0, 982.0, 83.0, 17.0 ],
					"text" : "script hide rad"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.0, 982.0, 113.0, 17.0 ],
					"text" : "script show rad-com"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 346.0, 982.0, 87.0, 17.0 ],
					"text" : "script show rad"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 153.0, 1028.0, 67.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 84.0, 197.0, 51.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 157.545471, 0.318011, 46.0, 19.0 ],
					"text" : "radius",
					"varname" : "rad-com"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.75, 800.009766, 29.5, 18.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 38.954628, 16.545475, 18.522072, 18.0 ],
					"rounded" : 4,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 89.0, 800.009766, 252.0, 19.0 ],
					"text" : "jcom.parameter threshold/mode @type boolean",
					"varname" : "pan/mode"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 33.681591, 197.0, 47.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 193.317795, 1.318011, 25.273037, 17.0 ],
					"triangle" : 0,
					"varname" : "rad"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 33.681591, 224.0, 251.0, 19.0 ],
					"text" : "jcom.parameter threshold/radius @type integer",
					"varname" : "threshold[3]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 198.409256, 22.545475, 28.0, 19.0 ],
					"text" : "inv."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 179.181885, 22.545475, 18.0, 18.0 ],
					"size" : 1,
					"values" : [ 0 ],
					"varname" : "color"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 150.545471, 23.545475, 35.0, 19.0 ],
					"text" : "color"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 33.681591, 341.0, 375.0, 19.0 ],
					"text" : "jcom.parameter noise/on @type boolean @description \"Noise reduction\"",
					"varname" : "noise[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 33.681591, 275.0, 401.0, 19.0 ],
					"text" : "jcom.parameter threshold/amount @type decimal @description \\\"Threshold\\\"",
					"varname" : "threshold[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 429.5, 170.0, 99.0, 19.0 ],
					"text" : "jalg.nav.motion%"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 418.5, 159.0, 519.0, 159.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 43.181591, 243.0, 30.0, 243.0, 30.0, 189.0, 43.181591, 189.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 43.181591, 210.0, 43.181591, 210.0 ],
					"source" : [ "obj-30", 0 ]
				}
