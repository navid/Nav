...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0, 384.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 473.0, 307.0, 150.0, 70.0 ],
					"presentation_rect" : [ 480.0, 323.0, 150.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 473.0, 231.0, 150.0, 70.0 ],
					"presentation_rect" : [ 480.0, 240.0, 150.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 317.0, 307.0, 150.0, 70.0 ],
					"presentation_rect" : [ 316.0, 323.0, 150.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 317.0, 231.0, 150.0, 70.0 ],
					"presentation_rect" : [ 316.0, 240.0, 150.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 473.0, 154.0, 150.0, 70.0 ],
					"presentation_rect" : [ 481.0, 164.0, 150.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 473.0, 78.0, 150.0, 70.0 ],
					"presentation_rect" : [ 481.0, 81.0, 150.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 317.0, 154.0, 150.0, 70.0 ],
					"presentation_rect" : [ 319.0, 209.0, 150.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 317.0, 78.0, 150.0, 70.0 ],
...
,
					"patching_rect" : [ 75.0, 98.0, 30.0, 20.0 ],
...
,
					"patching_rect" : [ 42.0, 98.0, 24.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 42.0, 75.0, 20.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 8.0, 98.0, 28.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 8.0, 75.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 273.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-9",
					"maxclass" : "bpatcher",
					"name" : "jmod.fof~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "signal" ],
					"patching_rect" : [ 8.0, 126.0, 300.0, 140.0 ],
					"presentation_rect" : [ 15.0, 15.0, 300.0, 140.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jmod.fof~.maxpat",
				"bootpath" : "/Users/NavNav/code/Git/Nav/Jamoma/jmod.nav.fof~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
