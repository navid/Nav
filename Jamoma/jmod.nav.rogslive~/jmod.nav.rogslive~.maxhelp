...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 769.0, 191.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 327.0, 127.0, 343.0, 20.0 ],
					"text" : "scrub"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.nav.sur.rogs~", "@description", "multichannel Rogs~ granulator with realtime input and 1-24 channels of output" ],
					"bgmode" : 1,
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 1134.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 332.0, 470.5, 12.0, 61.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 361.0, 490.5, 12.0, 61.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 388.0, 470.5, 12.0, 61.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 388.0, 402.5, 12.0, 61.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 361.0, 378.5, 12.0, 61.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 332.0, 402.5, 12.0, 61.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 349.0, 345.0, 100.0, 20.0 ],
					"text" : "jcom.unpack≈ 6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 193.0, 23.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 313.0, 210.0, 198.0, 20.0 ],
					"text" : "<-"
				}
...
,
					"patching_rect" : [ 7.0, 159.0, 49.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 77.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 327.0, 77.0, 186.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 343.0, 161.0, 328.0, 33.0 ],
					"text" : "dependancies:\nRogs~ (from IRCAM Forum)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 306.5, 286.0, 239.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 458.0, 330.0, 198.0, 47.0 ],
					"text" : "<- Changes to these (red) parameters are not effective unless/untill dsp engine is off"
				}
...
,
					"patching_rect" : [ 327.0, 193.0, 217.0, 20.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 481.0, 290.0, 134.0, 47.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 13.0,
...
, 			{
				...
				"patcherrelativepath" : "../../code/Git/Synthesis/O4_ASU/O4.video/Storytelling_v1.0/Max Patches Libs/WoMax v1.6b/patches",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
